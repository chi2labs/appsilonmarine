...
golem::fill_desc(
  ...
  pkg_title = "Appsilon Marine Application", # The Title of the package containing the App
  pkg_description = "PKG_DESC.", # The Description of the package containing the App
  author_first_name = "Pablo", # Your First Name
  author_last_name = "Pagnone", # Your Last Name
  author_email = "pablodp84@gmail.com", # Your Email
