...
The textbook definition of *outlier* is any observation outside 1.5 times the interquartile range. We se that this gives a value of rougly 90 km/h. The validity of this approach is quiestionable, however, since it assumes at least a quasi-normal distribution of the data, which we clearly do not have here. 
