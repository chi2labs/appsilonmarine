...
* [Initial Look at the Raw Data](https://github.com/chi2labs/appsilonmarine/blob/master/dev_docs/data_initial_look.md)
* [Evaluation of Some Data-Related Issues](https://github.com/chi2labs/appsilonmarine/blob/master/dev_docs/data_considerations.md)
* [Post-hoc Analysis of Pre-Calculated Data](https://github.com/chi2labs/appsilonmarine/blob/master/dev_docs/post_hoc_analysis.md)
...
All distance calculations were made using the [geosphere](https://cran.r-project.org/package=geosphere) package. We have not independenlty verified the accuracy of these calculations.